...
export interface TranslationSchema {
  ...
  subscription: {
    ...
    removeAdsSubtitle: string;
    removeAdsBannerCta: string;
    contactUs: string;
    ...
    phoneCall: string;
    emailUs: string;
    haveActivationCode: string;
    featureUnlockTitle: string;
    featureUnlockDesc: string;
    unlockWithAdBtn: string;
    unlockAllFeaturesAdBtn: string;
    unlockedSuccessTitle: string;
    unlockedSuccessMsg: string;
    ...
    benefitNoAds: string;
    benefitAllFeatures: string;
    benefitUnlimited: string;
    enterFeatureBtn: string;
    contactChannelsTitle: string;
    activationSuccess: string;
    contactWhatsappFailed: string;
    contactPhoneFailed: string;
    enterCodePrompt: string;
    adSupportedFreeAccountTitle: string;
    adSupportedFreeAccountDesc: string;
    starterQuotaDesc: string;
    rewardAdUnlockNotice: string;
    contactUsAnytimeToRemoveAds: string;
  };
}
