...
const styles = StyleSheet.create({
  ...
  headerActionBtn: { width: 38, height: 38, borderRadius: radii.lg, backgroundColor: colors.primary[50], alignItems: 'center', justifyContent: 'center' },
  ...
  historyBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: colors.slate[100], paddingHorizontal: 12, paddingVertical: 8, borderRadius: radii.xl },
  historyBtnText: { fontSize: 12, fontWeight: '700', color: colors.slate[700], fontFamily: 'Cairo' },
  previewToggleBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: colors.primary[50], paddingHorizontal: 12, paddingVertical: 8, borderRadius: radii.xl },
  previewToggleBtnText: { fontSize: 12, fontWeight: '700', color: colors.primary[700], fontFamily: 'Cairo' },
  printMainBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: colors.emerald[600], paddingVertical: 8, borderRadius: radii.xl, ...shadows.xs },
  printMainBtnText: { fontSize: 13, fontWeight: '800', color: '#fff', fontFamily: 'Cairo' },

  previewCard: { backgroundColor: colors.surface, borderRadius: radii.xl, padding: spacing.md, borderWidth: 1, borderColor: colors.border.default, marginBottom: spacing.md, ...shadows.xs },
  ...
  stickerShopName: { fontSize: 9.5, fontWeight: '700', color: colors.slate[600], fontFamily: 'Cairo', textAlign: 'center' },
  stickerProdName: { fontSize: 11.5, fontWeight: '800', color: '#0f172a', fontFamily: 'Cairo', textAlign: 'center', marginVertical: 2 },
  stickerSku: { fontSize: 9, color: colors.slate[500], fontFamily: 'monospace' },
  ...
  stickerPriceEnlarged: { fontSize: 17, color: colors.primary[700] },

  sectionHeader: { fontSize: 12.5, fontWeight: '800', color: colors.text.secondary, textAlign: 'right', marginBottom: spacing.xs, marginRight: 4, fontFamily: 'Cairo' },
  optionsCard: { backgroundColor: colors.surface, borderRadius: radii.xl, padding: spacing.md, borderWidth: 1, borderColor: colors.border.default, marginBottom: spacing.md, ...shadows.xs },

  sizesGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 6 },
  sizeOptionBtn: { width: '31%', paddingVertical: 8, alignItems: 'center', borderRadius: radii.md, backgroundColor: colors.slate[50], borderWidth: 1, borderColor: colors.border.default },
  ...
  formatOptionBtn: { width: '31%', paddingVertical: 8, alignItems: 'center', borderRadius: radii.md, backgroundColor: colors.slate[50], borderWidth: 1, borderColor: colors.border.default },
  ...
  copyBtn: { width: 30, height: 30, borderRadius: radii.md, backgroundColor: colors.slate[100], alignItems: 'center', justifyContent: 'center' },
  ...
  segmentBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 4, paddingVertical: 8, borderRadius: radii.md, backgroundColor: colors.slate[50], borderWidth: 1, borderColor: colors.border.default },
  ...
  manualInput: { backgroundColor: colors.slate[50], borderRadius: radii.md, borderWidth: 1, borderColor: colors.border.default, paddingHorizontal: spacing.md, paddingVertical: spacing.sm, fontSize: 13, color: colors.text.primary, fontFamily: 'Cairo', marginTop: spacing.sm },
  ...
  quickActionBtn: { backgroundColor: colors.slate[100], paddingHorizontal: 8, paddingVertical: 4, borderRadius: radii.sm },
  quickActionText: { fontSize: 10.5, fontWeight: '700', color: colors.slate[600], fontFamily: 'Cairo' },
  autoGenBtn: { backgroundColor: colors.primary[600], flexDirection: 'row', alignItems: 'center', gap: 2 },

  searchBar: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.surface, borderRadius: radii.lg, paddingHorizontal: spacing.md, borderWidth: 1, borderColor: colors.border.default, marginBottom: spacing.sm },
  ...
  productRowSelected: { backgroundColor: colors.primary[50], borderRadius: radii.lg },
  checkBox: { width: 22, height: 22, borderRadius: 6, borderWidth: 1.5, borderColor: colors.slate[300], alignItems: 'center', justifyContent: 'center', marginRight: spacing.sm },
  ...
  prodPrice: { fontSize: 13, fontWeight: '800', color: colors.primary[700], fontFamily: 'Cairo' },
  ...
  historyCopiesBadge: { backgroundColor: colors.emerald[50], paddingHorizontal: 8, paddingVertical: 2, borderRadius: radii.sm },
  historyCopiesText: { fontSize: 11, fontWeight: '700', color: colors.emerald[700], fontFamily: 'Cairo' },
