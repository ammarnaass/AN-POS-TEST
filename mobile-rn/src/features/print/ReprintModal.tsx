...
const styles = StyleSheet.create({
  ...
  tplOption: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.slate[50], borderRadius: radii.xl, padding: spacing.sm + 2, borderWidth: 1, borderColor: colors.border.default },
  tplOptionSelected: { backgroundColor: colors.primary[50], borderColor: colors.primary[300] },
  checkDot: { marginRight: spacing.sm },
  tplName: { fontSize: 13, fontWeight: '700', color: colors.text.primary, fontFamily: 'Cairo' },
  tplNameSelected: { color: colors.primary[700], fontWeight: '800' },
  tplSub: { fontSize: 10.5, color: colors.text.tertiary, fontFamily: 'Cairo', marginTop: 1 },

  copiesCard: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: colors.slate[50], borderRadius: radii.xl, padding: spacing.sm + 2, borderWidth: 1, borderColor: colors.border.default },
  copiesControls: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  copyBtn: { width: 30, height: 30, borderRadius: radii.md, backgroundColor: colors.surface, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: colors.border.default },
  copiesCount: { fontSize: 14, fontWeight: '800', color: colors.text.primary, minWidth: 20, textAlign: 'center', fontFamily: 'Cairo' },

  historyCard: { backgroundColor: colors.slate[50], borderRadius: radii.xl, padding: spacing.md, borderWidth: 1, borderColor: colors.border.default, marginTop: spacing.xs },
  historyHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: spacing.xs, borderBottomWidth: 1, borderBottomColor: colors.border.subtle, paddingBottom: 6 },
  historyTitle: { fontSize: 12, fontWeight: '800', color: colors.text.secondary, fontFamily: 'Cairo' },
  emptyHistory: { fontSize: 11.5, color: colors.slate[400], textAlign: 'center', paddingVertical: 8, fontFamily: 'Cairo' },
  ...
  reprintBadgeText: { fontSize: 10, fontWeight: '700', color: colors.warning.dark, fontFamily: 'Cairo' },
  ...
  reprintSubmitBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: colors.primary[600], paddingVertical: 12, borderRadius: radii.xl, marginTop: spacing.md },
