...
const makeStyles = (colors: any, isDark: boolean) =>
  StyleSheet.create({
    ...
    scanBtnText: { fontSize: 12.5, fontWeight: '700', color: colors.primary[600], fontFamily: 'Cairo' },
    addPrinterBtn: {
      flex: 1,
      flexDirection: 'row',
      alignItems: 'center',
    ...
    discoveredAction: { fontSize: 10.5, fontWeight: '700', color: colors.primary[600], fontFamily: 'Cairo', marginTop: 4 },
    ...
    printerCardDefault: {
      ...
      backgroundColor: isDark ? colors.surfaceElevated : '#f8faff',
    },
    ...
    connBadgeText: { fontSize: 10.5, fontWeight: '700', color: colors.primary[600], fontFamily: 'Cairo' },
    defaultBadge: {
      flexDirection: 'row',
      alignItems: 'center',
      gap: 3,
    ...
    defaultBadgeText: { fontSize: 10.5, fontWeight: '700', color: colors.warning.text, fontFamily: 'Cairo' },
    sizeBadge: {
      backgroundColor: isDark ? colors.surfaceElevated : colors.slate[100],
      paddingHorizontal: 6,
      paddingVertical: 2,
    ...
    sizeBadgeText: { fontSize: 10.5, fontWeight: '600', color: colors.text.secondary, fontFamily: 'Cairo' },
    statusDotRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
    statusText: { fontSize: 10.5, color: isDark ? '#34d399' : colors.emerald[700], fontWeight: '700', fontFamily: 'Cairo' },
    statusDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: isDark ? '#10b981' : colors.emerald[600] },
    ...
    testBtnText: { fontSize: 12, fontWeight: '700', color: colors.primary[600], fontFamily: 'Cairo' },
    mappingsBtn: {
      flexDirection: 'row',
      alignItems: 'center',
      gap: 4,
    ...
    mappingsBtnText: { fontSize: 12, fontWeight: '600', color: colors.text.secondary, fontFamily: 'Cairo' },
    ...
    mappingTplName: { fontSize: 12, color: colors.primary[600], fontWeight: '600', fontFamily: 'Cairo' },
  });
