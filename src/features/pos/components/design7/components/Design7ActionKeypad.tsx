    ...
    >
      <div className="grid grid-cols-3 gap-1">
        ...
        >
          ...
          <span className="text-[9px] font-bold text-slate-800 leading-tight mt-0.5">الزبون</span>
        </button>
        ...
        <button
          ...
          type="button"
        >
          <svg className="w-4 h-4 text-slate-600 drop-shadow-xs" fill="currentColor" viewBox="0 0 24 24">
            <path d="M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"></path>
          </svg>
          <span className="text-[9px] font-bold text-slate-800 leading-tight mt-0.5">بحث السلع</span>
        </button>
        ...
        <button
          ...
          type="button"
        >
          <div className="w-4 h-4 rounded-full bg-sky-600 hover:bg-sky-500 text-white font-bold flex items-center justify-center text-[10px] italic shadow-xs">
            i
          </div>
          <span className="text-[9px] font-bold text-slate-800 leading-tight mt-0.5">تفاصيل</span>
        </button>
        ...
        >
          ...
          <span className="text-[9px] font-bold text-rose-700 leading-tight mt-0.5">حذف السطر</span>
        </button>
        ...
        >
          ...
          <span className="text-[9px] font-bold text-slate-800 leading-tight mt-0.5">أعلى (↑)</span>
        </button>
        ...
        >
          ...
          <span className="text-[9px] font-bold text-slate-800 leading-tight mt-0.5">صنف حر</span>
        </button>
        ...
        >
          ...
          <span className="text-[9px] font-bold text-slate-800 leading-tight mt-0.5">إنقاص (-)</span>
        </button>
        ...
        >
          ...
          <span className="text-[9px] font-black text-emerald-800 leading-tight mt-0.5">تأكيد</span>
        </button>
        ...
        >
          ...
          <span className="text-[9px] font-bold text-slate-800 leading-tight mt-0.5">زيادة (+)</span>
        </button>
        ...
        >
          ...
          <span className="text-[9px] font-bold text-slate-800 leading-tight mt-0.5">تسوية</span>
        </button>
        ...
        >
          ...
          <span className="text-[9px] font-bold text-slate-800 leading-tight mt-0.5">أسفل (↓)</span>
        </button>
        ...
        >
          ...
          <span className="text-[9px] font-bold text-teal-800 leading-tight mt-0.5">تعديل السعر</span>
        </button>
        ...
        >
          ...
          <span className="text-[9px] font-bold text-slate-800 leading-tight mt-0.5">آلة حاسبة</span>
        </button>
        ...
        >
          ...
          <span className="text-[9px] font-bold text-slate-800 leading-tight mt-0.5">كيبورد</span>
        </button>
      </div>
    </aside>
  );
